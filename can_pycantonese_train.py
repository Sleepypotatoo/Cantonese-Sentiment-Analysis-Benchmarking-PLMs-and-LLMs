...
DATA_PATH = "./5cls_data/hktvmall.csv"
MAX_LEN = 128
OUTPUT_DIR = "./saved_models/pycantonese_hktv_5emos_model"
...
def train():
    ...
    # 8. 开始训练
    print("🚀 使用 pycantonese 分词 + 本地 bert-base-cantonese 进行五分类训练...")
    trainer.train()
